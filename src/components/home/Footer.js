                    ...
                    <div className="row" style = {{borderBottom: '1px solid grey'}}>
                        ...
                        <div className="col s6 m4 links">
                            ...
                            <ul className = 'grey-text text-lighten-1' style= {{fontSize: '18px'}}>
                               <li className = 'scrollToHome'>Home</li>
                               <li className = 'scrollToAbout'>About Us</li>
                               <li className = 'scrollToServices'>Services</li>
                               <li className = 'scrollToProjects'>Projects</li>
                               <li className = 'scrollToReachUs'>Reach Us</li>
                            </ul>
                        </div>
